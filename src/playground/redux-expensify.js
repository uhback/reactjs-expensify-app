...
store.subscribe(() => {
    const state = store.getState(); // state 값을 state 변수에 저장
...
const expenseThree = store.dispatch(addExpense({ description: 'Tea', amount: 400, createdAt: -1200}));

// store.dispatch(removeExpense({ id: expenseOne.expense.id }));

// // need ID and update an amount object to 800
